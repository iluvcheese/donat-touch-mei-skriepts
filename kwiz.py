...
def skillissue():
    ...
    questiooooooooooooooooooooooooooooooooon = [message, "big skill issoe", "burito", "im hungry", "zkiep boetton no goed", 0]
    if skor==11:
...
def skiep():
    global questiooooooooooooooooooooooooooooooooon
    skillissue()
